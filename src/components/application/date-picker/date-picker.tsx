...
export const DatePicker = ({ value: valueProp, defaultValue, onChange, onApply, onCancel, 'aria-label': ariaLabel, ...props }: DatePickerProps) => {
    ...
    return (
        <AriaDatePicker shouldCloseOnSelect={false} aria-label={ariaLabel ?? 'Filter by date'} {...props} value={value} onChange={setValue}>
            <AriaGroup>
